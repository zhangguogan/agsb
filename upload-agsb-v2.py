...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "zgg"         # 用户名
UUID = "2707593f-1310-4c79-bcd8-fafb2daae1f7"                     # UUID，留空则自动生成
PORT = 49999                   # Vmess端口，留空或0则自动生成
DOMAIN = ""                   # 域名，留空则自动获取
CF_TOKEN = "cloudflared.exe service install eyJhIjoiN2VhODQ4ZTk1MzkyNzIxNTE3Y2VjOTMxNzgxZDA2NDkiLCJ0IjoiZTNlMDg1MTQtNzI4Ny00OWYzLTkyMjItOWE2YjZmNzg0YTk2IiwicyI6Ik5tUXlNVE14WXpZdFpqWTNZeTAwT0RFNExXSTVZakl0TVRRNE5tSmpNMkk1TXpaaiJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
